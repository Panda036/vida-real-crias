...
public OnPlayerText(playerid, text[])
{
    ...
    {
        SendClientMessage(playerid, 0xFF4000AA, "| ERRO | Você não está logado!");
        return false;
    }
...
public OnPlayerCommandText(playerid, cmdtext[])
{
    ...
    if(PlayerInfo[playerid][Logado] == false)
        return SendClientMessage(playerid, 0xFF4000AA, "| ERRO | Você não está logado!");

    if(PlayerInfo[playerid][Afk] == true)
        return SendClientMessage(playerid, 0xFF4000AA, "| ERRO | Antes de usar comando, digite: /Sairafk");

    if(PrisonEnum[playerid][pTempo] != 0)
        return SendClientMessage(playerid, 0xFF4000AA, "| ERRO | Você está preso e não pode usar comando!");

    if(Algemado[playerid] == true)
        return SendClientMessage(playerid, 0xFF4000AA, "| ERRO | Você está algemado e não pode usar comando!");
	...
	return SendClientMessage(playerid, 0xFF4000AA, "| ERRO | Comando Inválido!");
}
...
public OnPlayerEnterCheckpoint(playerid)
{
    ...
    if(cpid == cps_mafia)
        return ShowPlayerDialog(playerid, mob, DIALOG_STYLE_LIST, "{FF0000}Cargos", "{FFFFFF}Ladrão de gás ", "Selecionar", "Fechar");
...
public OnPlayerKeyStateChange(playerid, newkeys, oldkeys)
{
    if(PRESSED(KEY_YES))
    {
        ...
        {
            SendClientMessage(playerid, 0xFF4000AA, "| ERRO | Você não tem permissão!");
        }
    }
...
public OnDialogResponse(playerid, dialogid, response, listitem, inputtext[])
{
    ...
    if(dialogid == rename)
    {
        ...
        if(!response) return SendClientMessage(playerid, 0xFF4000AA, "| ERRO | Você cancelou a troca de nick!");
        return 1;
    }
    if(dialogid == radio)
    {
        ...
        if(response)
        {
            if(listitem == 0)
            {
                if(PlayerInfo[playerid][Reais] < 1000)
                    return SendClientMessage(playerid, 0xFF4000AA, "| ERRO | Infelizmente você não tem Reais o suficiente.");
    ...
    if(dialogid == cmds_adm_pg1)
    {
        if(response)
        {
            ...
            strcat(txt, "{87CEFF}/Cv [id][cor][cor] \t\t{FFFFFF}Para criar um veiculo em sua posição \n");
    ...
    if(dialogid == cmds_adm_pg2)
    {
        if(response)
        {
            ...
            ShowPlayerDialog(playerid, cmds_adm_pg3, DIALOG_STYLE_TABLIST_HEADERS, "{C0C0C0}Comandos da Admininstração - Página {00CA00}3", txt, "Próxima", "Cancelar");
        }
        return 1;
    }
	return 1;
...
forward OpeningPolicePort(playerid); public OpeningPolicePort(playerid)
{
    if(IsPlayerInRangeOfPoint(playerid, 2.0, 246.39900,72.49900,1003.85809))
    {
        ...
        SendClientMessage(playerid, Verde_Escurinho, "| INFO | O Portï¿½o do Departamento de Policia foi aberto e fechara em 5 segundos");
    }
    return 1;
}
...
Salario(playerid)
{
    switch(PlayerInfo[playerid][Profissao])
    {
        case Desempregado:
        {
        	...
        	format(String,sizeof(String),"{EDA909}» {FFFFFF}Salário: {00A600}$%d", Salario_Desempregado);
        	SendClientMessage(playerid, 0xEDA909AA, String);
        	format(String,sizeof(String),"{EDA909}» {FFFFFF}Balanço antigo: {FF0000}$%d", PlayerInfo[playerid][SaldoBancario]-Salario_Desempregado);
        	SendClientMessage(playerid, 0xEDA909AA, String);
        ...
        case EntregadorJornal:
        {
        	...
        	SendClientMessage(playerid, 0xEDA909AA,"~~~~~~~~~~~~~~~~~~~~~~ Salário ~~~~~~~~~~~~~~~~~~~~~~");
        	format(String,sizeof(String),"{EDA909}» {FFFFFF}Salário: {00A600}$%d", Salario_EntregadorJornal);
        	SendClientMessage(playerid, 0xEDA909AA, String);
        	format(String,sizeof(String),"{EDA909}» {FFFFFF}Balanço antigo: {FF0000}$%d", PlayerInfo[playerid][SaldoBancario]-Salario_EntregadorJornal);
        	SendClientMessage(playerid, 0xEDA909AA, String);
        	format(String,sizeof(String),"{EDA909}» {FFFFFF}Balanço atual: {00A600}$%d", PlayerInfo[playerid][SaldoBancario]);
        	SendClientMessage(playerid, 0xEDA909AA, String);
        	SendClientMessage(playerid, 0xEDA909AA,"~~~~~~~~~~~~~~~~~~~~~~ Salário ~~~~~~~~~~~~~~~~~~~~~~");
        ...
        case Taxi:
        {
        	...
        	SendClientMessage(playerid, 0xEDA909AA,"~~~~~~~~~~~~~~~~~~~~~~ Salário ~~~~~~~~~~~~~~~~~~~~~~");
        	format(String,sizeof(String),"{EDA909}» {FFFFFF}Salário: {00A600}$%d", Salario_Taxi);
        	SendClientMessage(playerid, 0xEDA909AA, String);
        	format(String,sizeof(String),"{EDA909}» {FFFFFF}Balanço antigo: {FF0000}$%d", PlayerInfo[playerid][SaldoBancario]-Salario_Taxi);
        	SendClientMessage(playerid, 0xEDA909AA, String);
        	format(String,sizeof(String),"{EDA909}» {FFFFFF}Balanço atual: {00A600}$%d", PlayerInfo[playerid][SaldoBancario]);
        	SendClientMessage(playerid, 0xEDA909AA, String);
        	SendClientMessage(playerid, 0xEDA909AA,"~~~~~~~~~~~~~~~~~~~~~~ Salário ~~~~~~~~~~~~~~~~~~~~~~");
        ...
        case PoliciaMunicipal:
        {
        	...
        	SendClientMessage(playerid, 0xEDA909AA,"~~~~~~~~~~~~~~~~~~~~~~ Salário ~~~~~~~~~~~~~~~~~~~~~~");
        	format(String,sizeof(String),"{EDA909}» {FFFFFF}Salário: {00A600}$%d", Salario_PoliciaMunicipal);
        	SendClientMessage(playerid, 0xEDA909AA, String);
        	format(String,sizeof(String),"{EDA909}» {FFFFFF}Balanço antigo: {FF0000}$%d", PlayerInfo[playerid][SaldoBancario]-Salario_PoliciaMunicipal);
        	SendClientMessage(playerid, 0xEDA909AA, String);
        	format(String,sizeof(String),"{EDA909}» {FFFFFF}Balanço atual: {00A600}$%d", PlayerInfo[playerid][SaldoBancario]);
        	SendClientMessage(playerid, 0xEDA909AA, String);
        	SendClientMessage(playerid, 0xEDA909AA,"~~~~~~~~~~~~~~~~~~~~~~ Salário ~~~~~~~~~~~~~~~~~~~~~~");
        ...
        case Corregedoria:
        {
        	...
        	SendClientMessage(playerid, 0xEDA909AA,"~~~~~~~~~~~~~~~~~~~~~~ Salário ~~~~~~~~~~~~~~~~~~~~~~");
        	format(String,sizeof(String),"{EDA909}» {FFFFFF}Salário: {00A600}$%d", Salario_Corregedoria);
        	SendClientMessage(playerid, 0xEDA909AA, String);
        	format(String,sizeof(String),"{EDA909}» {FFFFFF}Balanço antigo: {FF0000}$%d", PlayerInfo[playerid][SaldoBancario]-Salario_Corregedoria);
        	SendClientMessage(playerid, 0xEDA909AA, String);
        	format(String,sizeof(String),"{EDA909}» {FFFFFF}Balanço atual: {00A600}$%d", PlayerInfo[playerid][SaldoBancario]);
        	SendClientMessage(playerid, 0xEDA909AA, String);
        	SendClientMessage(playerid, 0xEDA909AA,"~~~~~~~~~~~~~~~~~~~~~~ Salário ~~~~~~~~~~~~~~~~~~~~~~");
