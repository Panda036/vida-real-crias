    ...
    if(dialogid == help)
    {
        if(response)
        {
            switch(listitem)
            {
                ...
                {
                    new txt[500];
                    strcat(txt, "{FFFFFF}»{FF0000} Fórum: {FFFFFF}https://vidaarealcrias.wordpress.com/ \n");
                    strcat(txt, "{FFFFFF}»{FF0000} Facebook: {FFFFFF}Em Breve \n");
                    strcat(txt, "{FFFFFF}»{FF0000} Discord: {FFFFFF}https://discord.gg/DScW7rm \n");
                    strcat(txt, "{FFFFFF}»{FF0000} Servidor v1.0.0: {FFFFFF}ca01.heavyhost.com.br:7794 \n");
