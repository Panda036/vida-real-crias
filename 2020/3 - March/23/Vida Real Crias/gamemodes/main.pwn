...
public OnDialogResponse(playerid, dialogid, response, listitem, inputtext[])
{
        ...
        if(response)
        {
            switch(listitem)
            {
                case 0:
                {
                    ...
                    strcat(txt, "{a4a4a4}Jogadores(as) VIPs terá que juntar 5 experiência para ganhar +1 level \n\n");
                ...
                case 1:
                {
                    ...
                    strcat(txt, "{a4a4a4}Jogadores(as) VIPs terá salário creditado ao completar UP ( 5/5 ) \n\n");
                    strcat(txt, "{a4a4a4}Cada profissão tem um salário diferente e justo \n\n");
                    strcat(txt, "{a4a4a4}Cargos da mafia não recebem salário \n");
                    ShowPlayerDialog(playerid, 0, DIALOG_STYLE_MSGBOX, "{FF0000}Ajuda Salï¿½rio", txt, "Fechar", "");
                }
                case 2:
                {
                    new txt[2000];
                	...
                	strcat(txt, "{00FFFF}»{FFFFFF} /Abastecer {FFFFFF}- Para abastecer um veï¿½culo em um determinado posto\n");
                	...
                	strcat(txt, "{00FFFF}»{FFFFFF} /193 [Local] {FFFFFF}- Para chamar a equipe de paramï¿½dicos\n");
                	strcat(txt, "{00FFFF}»{FFFFFF} /Duvida [Duvida]{FFFFFF}- Para tirar alguma dúvida com algum membro da Administraï¿½ï¿½o\n");
                ...
                {
                    new txt[500];
                    strcat(txt, "{FFFFFF}»{FF0000} Fórum: {FFFFFF}Em Breve \n");
    ...
    if(dialogid == cmds_adm_pg2 && response)
    {
        new txt[2800];
        strcat(txt, "{FF0000}Comandos \t\t{1CEB00}Informações\n");
        strcat(txt, "{87CEFF}/DarAdmin [id/nome][Nivel] \t\t{FFFFFF}Para promover/rebaixar/remover jogador(a) da admininstração\n");
        ...
        strcat(txt, "{87CEFF}/R [id/nome][resposta] \t\t{FFFFFF}Para responder a dúvida de um(a) jogador(a)\n");
    ...
    if(dialogid == cmds_adm_pg3 && response)
    {
        ...
        new txt[2800];
        strcat(txt, "{FF0000}Comandos \t\t{1CEB00}Informações\n");
        ShowPlayerDialog(playerid, cmds_adm_pg4, DIALOG_STYLE_TABLIST_HEADERS, "{C0C0C0}Comandos da Admininstração - Página {00CA00}4", txt, "Fechar", "Cancelar");
        return 1;
        */
    }
	return 1;
